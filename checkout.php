      ...
      <form action="" method="post">
         ...
         <div class="flex">
            ...
            <div class="inputBox">
               ...
               <select name="method">
                  <option value="cash on delivery">Debit Card</option>
            ...
            <div class="inputBox">
               <span>Address:</span>
               <input type="text" name="street" required placeholder="1199 Coleman Avenue">
            </div>
            <div class="inputBox">
               <span>Apt/Unit Number:</span>
               <input type="number" min="0" name="flat" required placeholder="205">
            </div>
            <div class="inputBox">
               <span>City:</span>
               <input type="text" name="city" required placeholder="San Jose">
            </div>
            <div class="inputBox">
               <span>State:</span>
            ...
            <div class="inputBox">
               <span>ZIP code:</span>
               <input type="number" min="0" name="pin_code" required placeholder="37212">
            </div>
         </div>
